...
const Index = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen">
          ...
          <div className="max-w-4xl mx-auto animate-fade-in">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">
              {user ? (
                <>
                  Bem-vindo de volta,
                  <span className="text-gradient block">Vamos treinar!</span>
                </>
              ) : (
                <>
                  Encontre seu
        ...
        <div className="container">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <Card key={index} className="text-center hover:shadow-xl transition-all duration-300 border-primary/20 bg-background/80 backdrop-blur group">
        ...
        <div className="container text-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 max-w-4xl mx-auto">
            {objectives.map((objective, index) => (
              <Card key={index} className="p-6 hover:shadow-lg transition-all duration-300 border-primary/20 bg-background/80 backdrop-blur group cursor-pointer">
      ...
      {/* CTA Section */}
      <section className="py-24 px-4 fitness-gradient text-white relative overflow-hidden">
            ...
            {user ? (
              <Link to="/dashboard">
                <Button 
                  size="lg" 
                  variant="secondary" 
                  className="bg-white text-primary hover:bg-white/90 transition-all duration-300 transform hover:scale-105 shadow-xl px-8 py-4 text-lg font-semibold"
                >
